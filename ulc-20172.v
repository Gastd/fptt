...
Proof.
  ...
  - intros.
    ...
    apply redex in H.
    apply transitive_reduction with s.
    + assumption.
    + inversion H0; subst.
      admit.
      admit.
  - intros.
    apply app_left with beta t0 t' u in H.
    admit.
  - intros.
    apply app_right with beta t0 u u' in H.
    admit.
  - intros.
    apply abs_in with beta t0 t' in H.
    admit.
Admitted.
...
Proof.
  ...
  - intros.
    assumption.
  - intros.
    apply star_transitive_closure_composition with u.
    + assumption.
    + assumption.
Qed.
